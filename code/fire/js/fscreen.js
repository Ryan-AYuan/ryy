/**
 * Functional Summary:
 * This file provides a cross-browser abstraction for the Fullscreen API.
 * It handles vendor prefixes (webkit, moz, ms) to ensure compatibility across different browsers.
 * It exposes a unified `fscreen` object with methods to request and exit fullscreen mode,
 * as well as event listeners for fullscreen changes and errors.
 */
